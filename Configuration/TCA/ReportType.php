...
$GLOBALS['TCA']['tx_clubmanagement_domain_model_reporttype'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_clubmanagement_domain_model_reporttype']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'name' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:clubmanagement/Resources/Private/Language/locallang_db.xlf:tx_clubmanagement_domain_model_reporttype.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
