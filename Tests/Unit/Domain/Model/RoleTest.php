...
/**
 * Test case for class \SpoonerWeb\Clubmanagement\Domain\Model\Role.
 *
...
class RoleTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \SpoonerWeb\Clubmanagement\Domain\Model\Role
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \SpoonerWeb\Clubmanagement\Domain\Model\Role();
	}
